"""
===========================================================
 FILE: compare_foa_gwo.py
 PURPOSE
-------
Compare classic FOA against GWO using the same scenarios,
same seeds, same population size, same number of iterations,
and same QoS configuration.

Outputs:
    - results/v0/foa_vs_gwo_convergence.csv
    - results/v0/foa_vs_gwo_convergence.png
===========================================================
"""
...
SAVE_DIR = "results/v0"
CSV_PATH = f"{SAVE_DIR}/foa_vs_gwo_convergence_N{N}_M{M}_RUNS{RUNS}_ITER{ITERATIONS}.csv"
FIG_PATH = f"{SAVE_DIR}/foa_vs_gwo_convergence_N{N}_M{M}_RUNS{RUNS}_ITER{ITERATIONS}.png"
...
def run_experiments():
    ...
    print("\n========================================")
    print(" FOA VS GWO CONVERGENCE COMPARISON")
    print("========================================")
    print(f"N               : {N}")
    print(f"M               : {M}")
    print(f"Runs            : {RUNS}")
    ...
    for run in range(RUNS):
        ...
        for iteration in range(ITERATIONS):
            ...
            rows.append({
                ...
                "iteration": iteration + 1,
                "algorithm": "GWO",
                "best_fitness": gwo_history[iteration]
            })
...
def plot_comparison(df):
    ...
    ax.set_title(
        f"FOA vs GWO Convergence Comparison over {RUNS} Independent Runs",
        fontsize=14,
        fontweight="bold"
    )
